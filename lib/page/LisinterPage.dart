...
import 'package:flutter_ui/otherpage/CustomSlider.dart';
...
class _LisinterPageState extends State<LisinterPage>
...
//  AudioPlayer audioPlayer = new AudioPlayer();
  ...
  StreamSubscription audioPlayPositionChange() {
    return AudioPlayerManager.onAudioPositionChanged((p) {
      //播放器发生变化直接挂在
      if (mounted) {
        //显示进度条
  ...
  StreamSubscription listenPlayer() {
    return AudioPlayerManager.onPlayerCompletionStream((event) {
      //播放一首就关闭流再开启流
      ...
      children: <Widget>[
        ...
        ListinerTabBar(
          ...
          onTap: (index) {
            ...
            index == 0
                ? _controller.animateTo(170,
                    duration: Duration(milliseconds: 500),
                    curve: Curves.fastOutSlowIn)
                : index == 1
                    ? _controller.animateTo(980,
                        duration: Duration(milliseconds: 500),
                        curve: Curves.fastOutSlowIn)
                    : _controller.animateTo(1350,
                        duration: Duration(milliseconds: 500),
                        curve: Curves.fastOutSlowIn);
          },
          currIndex: _tabIndex,
        ...
        children: <Widget>[
          Positioned(
              ...
              child: Material(
                ...
                child: InkWell(
                  onTap: () {
                    Store.value<AudioPlayModelNotifier>(context, 1)
                        .setIsPlayState(true);
...
//                    ToastUtil.dissmiss();
  ...
  Widget contentView() {
    return SingleChildScrollView(
      ...
      child: Column(children: <Widget>[_coverView(), LinsterContent()]),
    );
  }
  ...
  Widget _coverView() {
    return Container(
      ...
      padding: EdgeInsets.fromLTRB(0, 48, 0, 20),
      child: Column(
        children: <Widget>[
          Container(
            alignment: Alignment.center,
            ...
            child: new Text(
              '极品透视保镖-005(免费章节每天晚上七点我听直播间现场直播~)',
  ...
  Widget _controBtnsWidget() {
    ...
    var playBtn = playModel == 0
        ...
        : playModel == 1 ? 'images/single.png' : 'images/random.png';
    return Container(
      child: Row(
        ...
        children: <Widget>[
              ...
              children: <Widget>[
                ...
                Container(
                  child: new Text(
                    AudioPlayerManager.playModel == 0
                        ? "顺序播放"
                        : AudioPlayerManager.playModel == 1 ? "单一循环" : "随机播放",
          ...
          InkWell(
            ...
            child: Container(
              margin: EdgeInsets.only(bottom: 10),
              child:
                  Image.asset('images/next.png', fit: BoxFit.fill, width: 30),
            ),
          ),
          InkWell(
            onTap: () {
  ...
  Widget _songsListWidget() {
    return Container(
      ...
      child: ListView.builder(
        itemCount: AudioPlayerManager.listmodel.songList.length,
        itemBuilder: (context, index) {
          return InkWell(
            ...
            child: ListTile(
              title: Text(
                AudioPlayerManager.listmodel.songList[index].title,
                style: TextStyle(
        ...
        child: SliderTheme(
          ...
          child: Slider(
            ...
            onChanged: (newValue) {
              ...
              // 进度 -> 秒数
              int sec = (newValue * AudioPlayerManager.fileDuration).toInt();
              AudioPlayerManager.audioPlayer.seek(new Duration(seconds: sec));
            },
