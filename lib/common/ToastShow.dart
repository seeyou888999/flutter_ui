...
class ToastShow {
  ...
  static final int ANIMATED_MOVEMENT_BTBSHOW =4;
  static final int ANIMATED_MOVEMENT_SHOWMODAL = 5;
  ...
  static AnimationController _animalController;
  static CurvedAnimation _curve;
  static Animation<double> _offsetAnim;
  static ToastShow makeText({
...
//    }
  ...
  void show()  {
    ...
    }else if (_animated == ANIMATED_MOVEMENT_BTBSHOW){
      _makeTextShowBTB();
    } else if (_animated == ANIMATED_MOVEMENT_SHOWMODAL){
      _makeTextShowModal();
    } else {
...
//    }
  ...
  static  void _makeTextShowBTB() async{
    print(OverlayEntry);
    _overlayEntry = new OverlayEntry(
        builder: (BuildContext context) => Positioned(
          top: _top,
  ...
  static  void _makeTextShowModal() async{
    print('---------');
    _showing = true;
    var overlayState = Overlay.of(_context);
    AnimationController animalController = new AnimationController(vsync: overlayState);
    final CurvedAnimation curve = new CurvedAnimation(parent:
    animalController, curve: Curves.fastOutSlowIn);
    Animation<double> offsetAnim = new Tween(begin: 30.0, end: 0.0).animate(curve);
    //创建OverlayEntry
          ...
          child: AnimatedBuilder(
            builder: (context, _) {
                return Transform.translate(
                    offset: Offset(0.0, offsetAnim.value),
                );
            },
            child: Container(child:  new Text('123'),),
...
//    //平移动画
//    Animation<double> offsetAnim = new Tween(begin: _top, end: 0.0).animate(ffsetCurvedAnimation);
