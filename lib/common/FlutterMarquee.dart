...
import 'package:flutter_ui/common/flutter_marquee_item.dart'; //Timer
...
class FlutterMarquee extends StatefulWidget{
  ...
  FlutterMarquee(
      ...
      : assert(children != null || texts != null),
        ...
        this.singleStart = singleStart?? true,
...
class _FlutterMarquee extends State<FlutterMarquee> with
  ...
  void initState() {
    ...
    if (widget.autoStart && widget.singleStart) {
